...
describe('Pending Invites', () => {
    ...
    it('should navigate to the pending invites page', () => {
        PI_PersonalInfo.enterPersonalInfo('das@12.com321', 'namw', 'Georqge', 'username', 'Female')
    ...
    it('Verify that Enter the invalid Parent  Email with Blank Space.', () => {
        ...
        PI_addPlayer.checkfunction();
        PI_PersonalInfo.invalidParentDetailsWarning();
    ...
    xit('Verify that Enter the invalid Parent First Name.', () => {
        PI_PersonalInfo.visitPendinginvites();
