import { playerTableListing } from "../../../sample/Dev_Component/MemberList_C/listing/stList"
...
describe('Pending Invites', () => {
    ...
    it('Accept yhe cookies', () => {
        players.visitMembers();
        players.clickonaAcceptCookies();
    });
    ...
    it('search a player', () => {
        ...
        players.searchBar('jan{enter}'); // Searches for the player
    });

    xit('Verify the deletion of a player', () => {
        players.visitMembers();
    ...
    it('Verify the cancel deletion of a player', () => {
        players.visitMembers();
        players.clickon3DotOption();
        players.threeoptiondltion();
    ...
    it('Verify that resend invitation mail', () => {
        players.visitMembers();
        players.searchBar('jan{enter}');
        players.clickon3DotOption();
        players.threeopttionResendInvit()
        players.resendInvitaionMsg();
    });

    it('Verify that player is Assigned the group', () => {
        players.visitMembers();
        players.searchBar('jan{enter}');
        players.clickon3DotOption();
        players.threeopttionResendInvit();
    ...
    //Assign Group  >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    it('Verify that the marked player is Assigned the group', () => {
        players.visitMembers();
