...
export class addionalInfo {
    ...
    pI_EducationHeader = '#card4 > .header-players';
    pI_EducationInstitute = '#card4 > .card > .form-sample > .profile-padding > :nth-child(1) > .d-card > .d-card-body > .d-flex > [style="margin-bottom: 0rem;"] > .col-sm-12 > .form-control';
    pI_Discipline = '#card4 > .card > .form-sample > .profile-padding > :nth-child(1) > .d-card > .d-card-body > .d-flex > .mt-3 > .col-md-6 > .form-group > .col-sm-12 > .form-control';
    pI_EduStartyear = '#card4 > .card > .form-sample > .profile-padding > :nth-child(1) > .d-card > .d-card-body > .d-flex > .mt-3 > :nth-child(2) > .form-group > .col-sm-12 > .form-control';
    pI_EduEndyear = '.mt-3 > :nth-child(3) > .form-group > .col-sm-12 > .form-control';
    pI_EduSave = '#card4 > .card > .form-sample > .profile-padding > :nth-child(1) > .d-card > .d-card-body > .d-flex > .p-0 > .form-group > .col-sm-12 > .mat-ripple';
    ...
    verifySaveBtnDisabled() {
        cy.get(this.pI_EduSave).should('be.disabled');
    }
    ...
    enterInstitute(institute: string) {
        cy.get(this.pI_EducationInstitute)
            .should('have.attr', 'placeholder', 'Institute name') // Check placeholder
    ...
    //    Careers     >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    pI_CareersHeader = '#card5 > .header-players';
    pI_Academy = '#card5 > .card > .form-sample > .profile-padding > :nth-child(1) > .d-card > .d-card-body > .d-flex > [style="margin-bottom: 0rem;"] > .col-sm-12 > .form-control';
    pI_Role = '#card5 > .card > .form-sample > .profile-padding > :nth-child(1) > .d-card > .d-card-body > .d-flex > .mt-3 > .col-md-6 > .form-group > .col-sm-12 > .form-control';
    ...
    pI_Careersavebtn = '#card5 > .card > .form-sample > .profile-padding > :nth-child(1) > .d-card > .d-card-body > .d-flex > .p-0 > .form-group > .col-sm-12 > .mat-ripple';
    ...
    //    Achievements     >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    pI_AchievementHeader = '#card6'
    pI_Event = ':nth-child(6) > :nth-child(1) > .card-body > .card > .form-sample > .profile-padding > :nth-child(1) > .d-card > .d-card-body > .d-flex > [style="margin-bottom: 0rem;"] > .col-sm-12 > .form-control';
    ...
    pI_AchievementYear = ':nth-child(6) > :nth-child(1) > .card-body > .card > .form-sample > .profile-padding > :nth-child(1) > .d-card > .d-card-body > .d-flex > .mt-3 > :nth-child(2) > .form-group > .col-sm-12 > .form-control';
    pI_saveAchievements = ':nth-child(6) > :nth-child(1) > .card-body > .card > .form-sample > .profile-padding > :nth-child(1) > .d-card > .d-card-body > .d-flex > .col-md-3 > .form-group > .col-sm-12 > .mat-ripple';
