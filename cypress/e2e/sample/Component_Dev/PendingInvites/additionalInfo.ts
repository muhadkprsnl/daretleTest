...
export class addionalInfo {
    ...
    enterPhysicalWeight(weight: number) {
        cy.get(this.pI_Weight)
            .should('have.attr', 'placeholder', 'kg') // Check placeholder
            .type(weight.toString()); // Convert number to string before typing
    }

    fillphysic(height: number, weight: number) {
    ...
    pI_sportsHeader = '#card2 > .card > .card-body > .header-players';
    pI_position = '#card2 > .card > .card-body > .form-sample > .profile-padding > :nth-child(1) > .d-card > .d-card-body > .d-flex > .show-style > :nth-child(2) > .form-group > .col-sm-12 > .form-control';
    ...
    pI_addressHeader = "div[id='card3'] div[class='header-players mt-1 mb-4 col-lg-6 p-0']"
    ...
    pI_city = '.card-body > .form-sample > .profile-padding > :nth-child(1) > .d-card > .d-card-body > .flex-column > :nth-child(3) > :nth-child(1) > .form-group > .col-sm-12 > .form-control';
    ...
    pI_EducationInstitute = '#card4 > :nth-child(1) > .card-body > .card > .form-sample > .profile-padding > :nth-child(1) > .d-card > .d-card-body > .flex-column > [style="margin-bottom: 0rem;"] > .col-sm-12 > .form-control';
    ...
    pI_EduSave = '#card4 > :nth-child(1) > .card-body > .card > .form-sample > .profile-padding > :nth-child(1) > .d-card > .d-card-body > .flex-column > .p-0 > .form-group > .col-sm-12';
    pI_dtGreaterYear = '.col-sm-12 > :nth-child(3)';
    ...
    greaterYear() {
        cy.get(this.pI_dtGreaterYear)
            .should('be.visible')
            .and('contain', '*End year should be greater than start year');
    }
    ...
    pI_Academy = '#card5 > :nth-child(1) > .card-body > .card > .form-sample > .profile-padding > :nth-child(1) > .d-card > .d-card-body > .flex-column > [style="margin-bottom: 0rem;"] > .col-sm-12 > .form-control';
    ...
    pI_Careersavebtn = "div[id='card5'] div[class='col-md-3 p-0'] div[class='col-sm-12']";
    saveCareerbtn = '#card6 > :nth-child(1) > .card-body > .p-3 > .form-sample > .profile-padding > :nth-child(1) > .d-card > .d-card-body > .flex-column > .col-md-3 > .form-group > .col-sm-12';
    Savw = "form.form-sample button.btn-primary";
    saw = '#card5 > :nth-child(1) > .card-body > .card > .form-sample > .profile-padding > :nth-child(1) > .d-card > .d-card-body > .flex-column > .p-0 > .form-group > .col-sm-12 > .btn';
    pI_dltCareerCardbtn = '[style="float: right; cursor: pointer;"] > img';
    pI_CareerSavedCardbtn = '#card5 > :nth-child(1) > .card-body > .p-4 > .profile-padding > :nth-child(1) > .d-card > .d-card-body > .flex-column > .col-12 > .row > .col-md-6 > .education-box';

    clickSaveCareers() {
        cy.get(this.saw, { timeout: 10000 })  // Adjust the selector if necessary
            .should('be.visible')
            .click();
    }
    ...
    selectCareerStDate(startYear: number, startMonth: string, startDay: number) {
    ...
    selectCareerEndDate(endYear: number, endMonth: string, endDay: number) {
        // Open the date picker
    ...
    validtCareerEndYear() {
        ...
        cy.get(this.pI_dtGreaterYear)
            .should('be.visible')
            .and('contain', '*End date should be after start date');
    }
    ...
    pI_Event = '#card6 > :nth-child(1) > .card-body > .card > .form-sample > .profile-padding > :nth-child(1) > .d-card > .d-card-body > .flex-column > [style="margin-bottom: 0rem;"] > .col-sm-12 > .form-control';
    pI_Achievements = '#card6 > :nth-child(1) > .card-body > .card > .form-sample > .profile-padding > :nth-child(1) > .d-card > .d-card-body > .d-flex > .mt-3 > :nth-child(1) > .form-group > .col-sm-12 > .form-control';
    ...
    pI_saveAchievements = '#card6 > :nth-child(1) > .card-body > .card > .form-sample > .profile-padding > :nth-child(1) > .d-card > .d-card-body > .flex-column > .col-md-3 > .form-group > .col-sm-12 > .btn';
    ...
    enterEvent(event: string) {
        cy.get(this.pI_Event)
            .should('have.attr', 'placeholder', 'Event') // Check placeholder
